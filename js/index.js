...
const member1= document.querySelector(".team1");
const pic1 = document.querySelector(".img1");

member1.addEventListener("onmouseover", ()=>{
  pic1.style.diplay="block";
});
...
// const people = document.querySelectorAll('.member').forEach(person => new TeamLink(person));
